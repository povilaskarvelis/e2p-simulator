    ...
    try {
        ...
        function calculateMultivariateR2(p, predictorCorrelation, collinearity) {
            try {
                ...
                console.error("Error calculating multivariate R²:", error);
                return 0;
            }
        }
        ...
        function ensureLegendContainer() {
            try {
                ...
                console.error("Error ensuring legend container:", error);
                return null;
            }
        }
        ...
        function initializeR2Chart() {
            try {
                ...
                console.error("Error initializing R² chart:", error);
            }
        }
        ...
        function updateR2Plot() {
            try {
                ...
                console.error("Error updating R² plot:", error);
            }
        }
        ...
        function recordR2Curve() {
            try {
                ...
                console.error("Error recording R² curve:", error);
            }
        }
        ...
        console.error("Error initializing R² calculator:", error);
    }
}
